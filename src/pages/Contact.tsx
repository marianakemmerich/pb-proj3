      ...
      <div className='font-poppins'>
        <div className='p-12'>
          ...
          <div className='flex mt-12'>
            <div className='w-1/3 ml-12 p-4'>
              <div className='mb-8'>
                <div className='flex items-center space-x-2'>
                  <img src={loc} className='w-[22px] mr-4'/>
                  <p className='text-2xl font-bold'>Address</p>
                </div>
                <p className='text-sm ml-12'>236 5th SE Avenue, New <br /> York NY10000, United <br /> States</p>
              </div>
              <div className='mb-8'>
                <div className='flex items-center space-x-2'>
              ...
              <div className='mb-4'>
                <div className='flex items-center space-x-2'>
                  ...
                  <p className='text-2xl font-bold'>Working Time</p>
                </div>
                <p className='text-sm ml-14'>
